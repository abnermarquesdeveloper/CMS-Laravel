...
@section('content_header')
    <h1>
        Minhas Páginas
        <a href="{{ route('pages.create') }}" class="btn btn-sm btn-success" style="margin-left: 10px">Nova Página</a>
    </h1>
@endsection
                ...
                <tbody>
                     @foreach ($pages as $page)
                         <tr>
                             ...
                             <td>{{$page->title}}</td>
                             <td>
                                 <a href="/{{$page->slug}}" target="_blank" class="btn btn-sm btn-success" style="width: 55px">Ver</a>
